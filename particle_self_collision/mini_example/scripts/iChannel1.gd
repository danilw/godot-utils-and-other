...
func _process(delta):
	...
	self.material.set("shader_param/iMouse",Vector3(global_v.iMouse.x,global_v.iMouse.y,0))
	...
	self.material.set("shader_param/spawn1",false)
	self.material.set("shader_param/spawn2",false)
