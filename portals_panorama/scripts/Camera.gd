...
func _process(delta):
	...
	get_node("../p1/p1/Camera").rotation=self.rotation
	get_node("../p1/p1/Camera").translation=self.translation
	#get_node("../Viewport2/p_main/Camera").rotation=self.rotation
	#get_node("../Viewport2/p_main/Camera").translation=self.translation
